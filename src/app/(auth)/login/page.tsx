      ...
      <div className="w-full max-w-sm">
        ...
        {portal === "applicant" ? (
          ...
          <p className="text-center text-xs text-gray-400 dark:text-gray-500 mt-6 leading-relaxed">
            {portal === "bank"
              ? "Bank accounts are provisioned by e-BGX administration. Contact your admin for access."
              : "Admin access is restricted. Contact the platform owner for credentials."}
          </p>
        )}
      </div>
    </div>
