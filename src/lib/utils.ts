...
export function getBGStatusConfig(status: BGStatus): { label: string; color: string; bg: string; dot: string } {
  const map: Record<BGStatus, { label: string; color: string; bg: string; dot: string }> = {
    ...
    FD_REQUESTED:      { label: "FD Requested",      color: "text-orange-600",      bg: "bg-orange-50 dark:bg-orange-950",        dot: "bg-orange-500" },
    FD_PAID:           { label: "FD Paid",           color: "text-cyan-600",        bg: "bg-cyan-50 dark:bg-cyan-950",            dot: "bg-cyan-500" },
    BG_DRAFTING:       { label: "BG Drafting",       color: "text-indigo-600",      bg: "bg-indigo-50 dark:bg-indigo-950",        dot: "bg-indigo-500" },
